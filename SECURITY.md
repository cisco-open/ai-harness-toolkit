...
The `ai-harness-toolkit` maintainers take all security issues in the project
seriously. Thank you for improving the security of `ai-harness-toolkit`. We
appreciate your dedication to responsible disclosure and will make every effort
to acknowledge your contributions.

`ai-harness-toolkit` leverages GitHub's private vulnerability reporting.
